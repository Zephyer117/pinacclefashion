...
// Query: //define the query        *[            _type == "product"            && slug.current == $slug //grokquery fetching methods        ] | order(name asc) [0]
...
// Query: //define the query        *[            _type == "product"            && references(*[_type == "category" && slug.current == $categorySlug]._id) //grokquery fetching methods        ] | order(name asc)
...
// Query: //define the query        *[            _type == "product"            && name match $searchParam //grokquery fetching methods        ] | order(name asc)
...
declare module "@sanity/client" {
  interface SanityQueries {
    ...
    "   //define the query\n        *[\n            _type == \"product\"\n            && slug.current == $slug //grokquery fetching methods\n        ] | order(name asc) [0]\n        ": PRODUCT_BY_ID_QUERYResult;
    "   //define the query\n        *[\n            _type == \"product\"\n            && references(*[_type == \"category\" && slug.current == $categorySlug]._id) //grokquery fetching methods\n        ] | order(name asc)\n        ": PRODUCTS_BY_CATEGORY_QUERYResult;
